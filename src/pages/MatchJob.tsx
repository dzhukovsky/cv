			...
			<main className="mx-auto max-w-[860px] px-5 md:px-8 pt-2 pb-20">
				<Card className="p-5 md:p-7" elevation={4}>
					...
					{!ready && wordCount > 0 && (
						...
						>
							At least 20 words to get a meaningful match — paste a fuller
							description.
						</div>
					)}
				</Card>
		...
		<section className="fl-mica relative no-print -mt-14 pt-14">
			...
			<div className="relative mx-auto max-w-[860px] px-5 md:px-8 pt-10 pb-8 md:pt-16 md:pb-10">
				...
				<p
					...
					style={{ color: "var(--fl-fg-muted)" }}
				>
					Paste a job description below and we&rsquo;ll trim the CV to the parts
					that matter for that role — relevant projects, the right slice of the
					stack, removing the noise.
				</p>
			</div>
		</section>
	);
