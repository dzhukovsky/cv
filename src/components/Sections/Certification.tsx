...
export const Certification = (props: t.Certification): React.JSX.Element => {
  ...
  return (
    <Card className={mergeClasses(styles.root, flex.row)}>
      ...
      <Column className={styles.container}>
        ...
        <div className={styles.content}>
          <Text>
            {[props.issuingOrganization, 'Credential ID ' + props.credentialId]
              .filter((x) => x)
              .join(' · ')}
          </Text>
          <Text>
            {[
              'Issued ' +
                props.issueDate.toLocaleDateString('en-US', {
                  year: 'numeric',
                  month: 'short',
                }),
              props.expirationDate &&
                'Expires ' +
                  props.expirationDate?.toLocaleDateString('en-US', {
                    year: 'numeric',
                    month: 'short',
                  }),
            ]
