...
export const cv: CV = {
  ...
  location: { city: 'Gdansk', country: 'Poland', countryCode: 'PL' },
  ...
  technologies: [
    ...
    t('MS-SQL', 'Database', 'production', 9, 2026),
    t('Redis', 'Database', 'production', 4, 2026),
    t('KQL', 'Database', 'production', 1, 2026),
    t('MySQL', 'Database', 'production', 1, 2019),
    t('SSAS', 'Database', 'production', 2, 2022),
    t('SSRS', 'Database', 'production', 1, 2020),
    ...
    t('xUnit', 'Testing', 'production', 6, 2026),
    t('Moq', 'Testing', 'production', 4, 2024),
    t('NUnit', 'Testing', 'production', 1, 2020),
    t('JMeter', 'Testing', 'production', 1, 2024),
    t('Sumo Logic', 'Testing', 'production', 1, 2024),
    t('Git', 'Version Control', 'production', 6, 2026),
    t('SVN', 'Version Control', 'production', 1, 2024),
    t('TfVC', 'Version Control', 'production', 2, 2022),
  ],
  projects: [
    {
    ...
    },
    {
      ...
      tech: [
        ...
        t('HTML', 'Frontend'),
        t('CSS', 'Frontend'),
        t('SVN', 'Version Control'),
        t('xUnit', 'Testing'),
        t('Moq', 'Testing'),
        t('JMeter', 'Testing'),
        t('Sumo Logic', 'Testing'),
        t('IIS', 'DevOps'),
        t('Azure DevOps', 'DevOps'),
        t('PowerShell', 'DevOps'),
      ],
